...
const TRANSLATIONS = {
    en: {
        ...
        object_type: { 'Galaxy': 'Galaxy', 'Open Cluster': 'Open Cluster', 'Dark Nebula': 'Dark Nebula',
                      'Emission Nebula': 'Emission Nebula', 'Galaxy Group': 'Galaxy Group', 'Molecular Cloud': 'Molecular Cloud',
                      'Planetary Nebula': 'Planetary Nebula', 'Reflection Nebula': 'Reflection Nebula', 'Moon': 'Moon',
                      'Planet': 'Planet', 'Asterism': 'Asterism', 'Galaxy Cluster': 'Galaxy Cluster',
                      'Globular Cluster': 'Globular Cluster', 'Supernova Remnant': 'Supernova Remnant', 'Variable Star': 'Variable Star',
                      'Wolf-Rayet Nebula': 'Wolf-Rayet Nebula', 'HII Region': 'HII Region', 'Nebula': 'Nebula',
                      'Irregular Galaxy': 'Irregular Galaxy', 'Lenticular (S0) Galaxy': 'Lenticular (S0) Galaxy', 'Spiral Galaxy': 'Spiral Galaxy',
                      'Cl+N (Emission Nebula)': 'Cl+N (Emission Nebula)', 'HII (Emission Nebula)': 'HII (Emission Nebula)', 'Cluster+Nebulosity': 'Cluster+Nebulosity',
                      'Duplicate': 'Duplicate', 'Diffuse Nebula': 'Diffuse Nebula', 'Galaxy Pair': 'Galaxy Pair',
                      'Star Cluster': 'Star Cluster', 'Comet': 'Comet', 'Sun': 'Sun',
                      'Milky Way': 'Milky Way', 'Other': 'Other', 'Double Star': 'Double Star',
                      'Elliptical Galaxy': 'Elliptical Galaxy', 'Galaxy Duo': 'Galaxy Duo', 'Group/Asterism': 'Group/Asterism',
    ...
    fr: {
        ...
        object_type: { 'Galaxy': 'Galaxie', 'Open Cluster': 'Amas ouvert', 'Dark Nebula': 'Nébuleuse sombre',
                      'Emission Nebula': 'Nébuleuse à émission', 'Galaxy Group': 'Groupe de galaxies', 'Molecular Cloud': 'Nuage moléculaire',
                      'Planetary Nebula': 'Nébuleuse planétaire', 'Reflection Nebula': 'Nébuleuse par réflexion', 'Moon': 'Lune',
                      'Planet': 'Planète', 'Asterism': 'Asterisme', 'Galaxy Cluster': 'Amas de galaxies',
                      'Globular Cluster': 'Amas globulaire', 'Supernova Remnant': 'Restes de supernova', 'Variable Star': 'Étoile variable',
                      'Wolf-Rayet Nebula': 'Nébuleuse Wolf-Rayet', 'HII Region': 'Région HII', 'Nebula': 'Nébuleuse',
                      'Irregular Galaxy': 'Galaxie irrégulière', 'Lenticular (S0) Galaxy': 'Galaxie lenticulaire (S0)', 'Spiral Galaxy': 'Galaxie spirale',
                      'Cl+N (Emission Nebula)': 'Cl+N (Nébuleuse à émission)', 'HII (Emission Nebula)': 'HII (Nébuleuse à émission)', 'Cluster+Nebulosity': 'Amas + Nébuleuse',
                      'Duplicate': 'Dupliqué', 'Diffuse Nebula': 'Nébuleuse diffuse', 'Galaxy Pair': 'Paire de galaxies',
                      'Star Cluster': "Amas d'étoiles", 'Comet': 'Comète', 'Sun': 'Soleil',
                      'Milky Way': 'Voie lactée', 'Other': 'Autre', 'Double Star': 'Étoile double',
                      'Elliptical Galaxy': 'Galaxie elliptique', 'Galaxy Duo': 'Duo de galaxies', 'Group/Asterism': 'Groupe/Astérisme',
    ...
    es: {
        ...
        object_type: { 'Galaxy': 'Galaxia', 'Open Cluster': 'Cúmulo abierto', 'Dark Nebula': 'Nebulosa Oscura',
                      'Emission Nebula': 'Nebulosa de emisión', 'Galaxy Group': 'Grupo Galaxia', 'Molecular Cloud': 'Nube molecular',
                      'Planetary Nebula': 'Nebulosa planetaria', 'Reflection Nebula': 'Nebulosa de reflexión', 'Moon': 'Luna',
                      'Planet': 'Planeta', 'Asterism': 'Asterismo', 'Galaxy Cluster': 'Cúmulo de galaxias',
                      'Globular Cluster': 'Cúmulo globular', 'Supernova Remnant': 'Remanente de supernova', 'Variable Star': 'Estrella variable',
                      'Wolf-Rayet Nebula': 'Nebulosa Wolf-Rayet', 'HII Region': 'Región HII', 'Nebula': 'Nebulosa',
                      'Irregular Galaxy': 'Galaxia irregular', 'Lenticular (S0) Galaxy': 'Galaxia Lenticular (S0)', 'Spiral Galaxy': 'Galaxia espiral',
                      'Cl+N (Emission Nebula)': 'Cl+N (Nebulosa de Emisión)', 'HII (Emission Nebula)': 'HII (Nebulosa de Emisión)', 'Cluster+Nebulosity': 'Cúmulo+Nebulosidad',
                      'Duplicate': 'Duplicado', 'Diffuse Nebula': 'Nebulosa difusa', 'Galaxy Pair': 'Par de galaxias',
                      'Star Cluster': 'Cúmulo de estrellas', 'Comet': 'Cometa', 'Sun': 'Sol',
                      'Milky Way': 'Vía Láctea', 'Other': 'Otro', 'Double Star': 'Estrella doble',
                      'Elliptical Galaxy': 'Galaxia elíptica', 'Galaxy Duo': 'Dúo galaxia', 'Group/Asterism': 'Grupo/Asterismo',
    ...
    de: {
        ...
        object_type: { 'Galaxy': 'Galaxis', 'Open Cluster': 'Offener Sternhaufen', 'Dark Nebula': 'Dunkler Nebel',
                      'Emission Nebula': 'Emissionsnebel', 'Galaxy Group': 'Galaxiengruppe', 'Molecular Cloud': 'Molekulare Wolke',
                      'Planetary Nebula': 'Planetarischer Nebel', 'Reflection Nebula': 'Reflexionsnebel', 'Moon': 'Mond',
                      'Planet': 'Planet', 'Asterism': 'Asterismus', 'Galaxy Cluster': 'Galaxienhaufen',
                      'Globular Cluster': 'Kugelsternhaufen', 'Supernova Remnant': 'Supernova-Überrest', 'Variable Star': 'Variabler Stern',
                      'Wolf-Rayet Nebula': 'Wolf-Rayet-Nebel', 'HII Region': 'HII-Region', 'Nebula': 'Nebel',
                      'Irregular Galaxy': 'Unregelmäßige Galaxie', 'Lenticular (S0) Galaxy': 'Linsenförmige (S0) Galaxie', 'Spiral Galaxy': 'Spiralgalaxie',
                      'Cl+N (Emission Nebula)': 'Cl+N (Emissionsnebel)', 'HII (Emission Nebula)': 'HII (Emissionsnebel)', 'Cluster+Nebulosity': 'Sternhaufen+Nebel',
                      'Duplicate': 'Duplikat', 'Diffuse Nebula': 'Diffuser Nebel', 'Galaxy Pair': 'Galaxienpaar',
                      'Star Cluster': 'Sternhaufen', 'Comet': 'Komet', 'Sun': 'Sonne',
                      'Milky Way': 'Milchstraße', 'Other': 'Andere', 'Double Star': 'Doppelstern',
                      'Elliptical Galaxy': 'Elliptische Galaxie', 'Galaxy Duo': 'Galaxienduo', 'Group/Asterism': 'Gruppe/Asterismus',
    ...
    it: {
        ...
        object_type: { 'Galaxy': 'Galassia', 'Open Cluster': 'Cluster aperto', 'Dark Nebula': 'Nebulosa Oscura',
                      'Emission Nebula': 'Nebulosa ad emissione', 'Galaxy Group': 'Gruppo di Galassie', 'Molecular Cloud': 'Nube molecolare',
                      'Planetary Nebula': 'Nebulosa planetaria', 'Reflection Nebula': 'Nebulosa a riflessione', 'Moon': 'Luna',
                      'Planet': 'Pianeta', 'Asterism': 'Asterismo', 'Galaxy Cluster': 'Ammasso di galassie',
                      'Globular Cluster': 'Ammasso globulare', 'Supernova Remnant': 'Resto di supernova', 'Variable Star': 'Stella variabile',
                      'Wolf-Rayet Nebula': 'Nebulosa Wolf-Rayet', 'HII Region': 'Regione HII', 'Nebula': 'Nebulosa',
                      'Irregular Galaxy': 'Galassia irregolare', 'Lenticular (S0) Galaxy': 'Galassia lenticolare (S0)', 'Spiral Galaxy': 'Galassia a spirale',
                      'Cl+N (Emission Nebula)': 'Cl+N (Nebulosa a Emissione)', 'HII (Emission Nebula)': 'HII (Nebulosa a Emissione)', 'Cluster+Nebulosity': 'Ammasso+Nebulosità',
                      'Duplicate': 'Duplicato', 'Diffuse Nebula': 'Nebulosa diffusa', 'Galaxy Pair': 'Coppia di galassie',
                      'Star Cluster': 'Ammasso stellare', 'Comet': 'Cometa', 'Sun': 'Sole',
                      'Milky Way': 'Via Lattea', 'Other': 'Altro', 'Double Star': 'Doppia Stella',
                      'Elliptical Galaxy': 'Galassia ellittica', 'Galaxy Duo': 'Duo di Galassie', 'Group/Asterism': 'Gruppo/Asterismo',
    ...
    pt: {
        ...
        object_type: { 'Galaxy': 'Galáxia', 'Open Cluster': 'Cluster aberto', 'Dark Nebula': 'Nebulosa Negra',
                      'Emission Nebula': 'Nebulosa de Emissão', 'Galaxy Group': 'Grupo de Galáxias', 'Molecular Cloud': 'Nuvem Molecular',
                      'Planetary Nebula': 'Nebulosa Planetária', 'Reflection Nebula': 'Nebulosa de Reflexão', 'Moon': 'Lua',
                      'Planet': 'Planeta', 'Asterism': 'Asterismo', 'Galaxy Cluster': 'Aglomerado de Galáxias',
                      'Globular Cluster': 'Aglomerado Globular', 'Supernova Remnant': 'Remanescente de Supernova', 'Variable Star': 'Estrela Variável',
                      'Wolf-Rayet Nebula': 'Nebulosa Wolf-Rayet', 'HII Region': 'Região HII', 'Nebula': 'Nebulosa',
                      'Irregular Galaxy': 'Galáxia Irregular', 'Lenticular (S0) Galaxy': 'Galáxia Lenticular (S0)', 'Spiral Galaxy': 'Galáxia Espiral',
                      'Cl+N (Emission Nebula)': 'Cl+N (Nebulosa de Emissão)', 'HII (Emission Nebula)': 'HII (Nebulosa de Emissão)', 'Cluster+Nebulosity': 'Cluster+Nebulosidade',
                      'Duplicate': 'Duplicado', 'Diffuse Nebula': 'Nebulosa Difusa', 'Galaxy Pair': 'Par de Galáxias',
                      'Star Cluster': 'Aglomerado Estelar', 'Comet': 'Cometa', 'Sun': 'Sol',
                      'Milky Way': 'Via Láctea', 'Other': 'Outro', 'Double Star': 'Estrela Dupla',
                      'Elliptical Galaxy': 'Galáxia Elíptica', 'Galaxy Duo': 'Galáxia Dupla', 'Group/Asterism': 'Grupo/Asterismo',
    ...
    _renderTonight(card) {
        ...
        if (Array.isArray(targets) && targets.length) {
            targets.slice(0, this._config.top_targets || 5).forEach(target => {
                ...
                const objectTypeKey = `object_type.${target.object_type}`;
                const objectType = t(objectTypeKey) === objectTypeKey ? target.object_type : t(objectTypeKey);
                row.appendChild(el('span', 'meta', [
                    objectType, target.constellation,
